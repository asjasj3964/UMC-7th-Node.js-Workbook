...
import { bodyToMemberMission } from "../dtos/participated-mission.dto.ts";
import { memberMissionRegist, memberMissionUpdateCompleted, listMemberMissions } from "../services/participated-mission.service.ts";
import { NotExistError } from "../errors.ts";
import { Response, Request, NextFunction } from 'express';

// 참여 미션 등록 핸들러
export const handleMemberMissionRegist = async(req: Request, res: Response, next: NextFunction) => {
    /*
...
export const handleMissionUpdateCompleted = async(req: Request, res: Response, next: NextFunction) => {
    /* 
    #swagger.tags = ['participated-mission-controller']
    ...
    */
    ...
    const missions = await memberMissionUpdateCompleted(
        memberId,
        BigInt(req.params.participatedMissionId),
    )
    res.status(StatusCodes.OK).success(missions);
}

// 나의 진행 중인 모든 미션 조회
export const handleListMemberMission = async(req: Request, res: Response, next: NextFunction) => {
    /*
