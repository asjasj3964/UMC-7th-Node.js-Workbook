...
import { Strategy as GoogleStrategy, Profile as GoogleProfile } from "passport-google-oauth20"; //  Google 로그인 Strategy 클래스 이용
...
export const naverStrategy = new NaverStrategy(
    ...
    (accessToken: string, refreshToken: string, profile: NaverProfile, cb: Function) => {
        console.log(profile);
