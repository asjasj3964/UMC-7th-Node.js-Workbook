...
export const setRestaurantFoodKind = async(restaurantId: bigint, foodKindId: bigint) => {
    try{
...
export const getRestaurantFoodKindByRestaurantId = async(restaurantId: bigint) => {
    try{
...
// 특정 식당의 모든 리뷰 조회
export const getAllRestaurantReviews = async (restaurantId: bigint, cursor: number) => {
    try{
...
// 특정 식당의 모든 미션 조회
export const getAllRestaurantMissions = async(restaurantId: bigint, cursor: number) => {
    try{
